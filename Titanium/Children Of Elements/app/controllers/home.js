...
function hidePlanets(e){
	...
	if(controlPlanetID  != selectedElement  ){
			...
			if ($.home.children) {
				...
				for (var c = 0; c < $.home.children.length ; c++) {
...
function  openBookshelf(_target){
 	...
 	var seleccionado  = _target;
		...
		function animationHandlerOpenBookshelf() {
				...
				var bookshelfx = Alloy.createController('bookshelf', {currentItem: _target, prev:$.home}).getView();
...
$.home.addEventListener('open', function(ev) {
