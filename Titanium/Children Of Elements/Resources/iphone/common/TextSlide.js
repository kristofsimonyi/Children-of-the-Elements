...
TextSlide.prototype.createTextSlide = function() {
    var customFont = "Oldenburg";
    "android" == Ti.Platform.osname && (customFont = "Oldenburg-Regular");
    ...
    var slideText;
    slideText = "es" == Ti.Locale.currentLanguage ? this.slideInfo.text_ES : this.slideInfo.text_EN;
