...
import com.childrenoftheelements.story.stories.StoryFirst;
...
public class Bookshelf extends Activity {
    ...
    public void muestraHistoria(View view){

        Intent intent = new Intent( Bookshelf.this, StoryFirst.class);
